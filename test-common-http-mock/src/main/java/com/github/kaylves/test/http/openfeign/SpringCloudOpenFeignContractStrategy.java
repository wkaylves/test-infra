package com.github.kaylves.test.http.openfeign;

import com.github.kaylves.test.http.feign.FeignAnnotationUtils;
...
import com.github.kaylves.test.http.feign.FeignParamIndexes;
import feign.Feign;
